...
I’m a DevOps / Platform Engineer focused on building and running production Kubernetes clusters on bare metal. Most of my work revolves around GitOps, observability, and making sure things don’t go down when they shouldn’t.
...
- **WynnAspects** — a microservices platform running on bare-metal Kubernetes  
  Built with ArgoCD GitOps, Harbor registry, CloudNativePG PostgreSQL, Longhorn storage, and Cloudflare at the edge. Services are instrumented with OpenTelemetry for tracing and metrics.

- **Personal Kubernetes setup** — 2-node bare-metal cluster  
  Runs e-commerce (PrestaShop + MariaDB), automation (n8n), and some bot workloads. Fully managed with ArgoCD ApplicationSets and Renovate, plus a full monitoring stack.
